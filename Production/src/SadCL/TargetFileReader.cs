...
{
    abstract class TargetFileReader
    {
        public abstract List<Target> read();
    ...
    class INITargetFileReader : TargetFileReader
    {
         ...
         * Read target file
         */
        public override List<Target> read()
        {
    ...
    class TargetFileReaderFactory
    {
        public static TargetFileReader Create(string fileName)
        {
            string extension = Path.GetExtension(fileName).ToLower();
            TargetFileReader reader = null;
            switch(extension)
            {
